...
This document explains how Tamias handles credit card transactions from different banking providers to ensure correct categorization and amount signs.
...
| `cashAccountType` / `cash_account_type` | Tamias Type |
|----------------------------------------|-------------|
| `CARD` | `credit` |
| `LOAN` | `other_asset` |
