    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        ...
        <DropdownMenuCheckboxItem
          ...
          onCheckedChange={() => setParams({ sort: "alphabetical", order: "asc" })}
        >
          Alphabetically
        </DropdownMenuCheckboxItem>
        ...
        <DropdownMenuCheckboxItem
          ...
          onCheckedChange={() => setParams({ sort: "document_date", order: "desc" })}
        >
        ...
        <DropdownMenuCheckboxItem
          ...
          onCheckedChange={() => setParams({ sort: "document_date", order: "asc" })}
        >
