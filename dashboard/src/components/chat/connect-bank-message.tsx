  ...
  return (
    <div className="w-full border p-4 space-y-4">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            To answer financial questions, I need access to your bank transactions and balances.
      ...
      <div className="flex gap-2 ml-11">
        ...
        <Button onClick={handleMaybeLater} variant="outline" className="text-primary">
          Maybe later
        </Button>
      </div>
    </div>
