...
import { DialogContent, DialogDescription, DialogHeader, DialogTitle } from "@tamias/ui/dialog";
...
export function InviteTeamMembersModal({ onOpenChange }: InviteTeamMembersModalProps) {
  return (
