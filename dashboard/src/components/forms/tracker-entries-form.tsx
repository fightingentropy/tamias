...
import { TimeRangeInput } from "@tamias/ui/time-range-input";
...
export function TrackerEntriesForm({
  ...
  useEffect(() => {
    ...
    form.setValue("assignedId", assignedId ?? userId);
  ...
  }, [start, stop, projectId, description, eventId, assignedId, userId]);
