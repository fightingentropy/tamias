...
const accountTypeLabelKey = {
  credit: "account_type.credit",
  depository: "account_type.depository",
  other_asset: "account_type.other_asset",
  loan: "account_type.loan",
  other_liability: "account_type.other_liability",
} as const;
      ...
      <div className="flex items-start justify-between">
        <div className="flex flex-col gap-1">
          ...
          <span className="text-xs text-[#878787] capitalize">
            {type ? t(accountTypeLabelKey[type]) : t("account_type.depository")}
          </span>
        </div>
                        ...
                        <div className="text-sm space-y-1">
                          ...
                          <p className="text-amber-700 dark:text-amber-300">
                            {provider
                              ...
                              : "Manual account data is stored only in Tamias and cannot be recovered."}
                          </p>
                        </div>
                      </div>
                    </div>
