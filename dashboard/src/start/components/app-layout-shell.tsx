...
export function AppLayoutShell(props: {
  ...
  return (
    <HydrationBoundary state={props.dehydratedState as DehydratedState | null | undefined}>
      <CurrentUserProvider initialUser={props.user}>
        <SidebarProvider>
          <div className="relative">
            <Sidebar />

            <div className="md:ml-[var(--sidebar-width,232px)] pb-4 transition-[margin] duration-200">
              <Header />
              <TrialGuard plan={props.user.team?.plan} createdAt={props.user.team?.createdAt}>
