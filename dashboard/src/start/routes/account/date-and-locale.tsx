...
export const loadAccountDateAndLocaleData = createServerFn({ method: "GET" }).handler(async () => {
  const { buildAccountDateAndLocalePageData } = await import("@/start/server/route-data/account");
