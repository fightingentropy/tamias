...
export const loadTransactionCategoriesData = createServerFn({ method: "GET" }).handler(async () => {
  const { buildTransactionCategoriesPageData } =
    await import("@/start/server/route-data/transactions");
