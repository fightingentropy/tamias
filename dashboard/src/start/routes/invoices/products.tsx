...
export const loadInvoiceProductsData = createServerFn({ method: "GET" }).handler(async () => {
  const { buildInvoiceProductsPageData } = await import("@/start/server/route-data/invoices");
