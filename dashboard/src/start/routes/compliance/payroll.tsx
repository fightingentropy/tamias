...
export const loadCompliancePayrollData = createServerFn({ method: "GET" }).handler(async () => {
  const { buildCompliancePayrollPageData } = await import("@/start/server/route-data/compliance");
