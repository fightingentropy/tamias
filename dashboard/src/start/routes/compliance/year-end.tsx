...
export const loadComplianceYearEndData = createServerFn({ method: "GET" }).handler(async () => {
  const { buildComplianceYearEndPageData } = await import("@/start/server/route-data/compliance");
