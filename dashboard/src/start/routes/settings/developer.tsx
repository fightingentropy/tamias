...
export const loadSettingsDeveloperData = createServerFn({ method: "GET" }).handler(async () => {
  const { buildSettingsDeveloperPageData } =
    await import("@/start/server/route-data/settings-developer");
