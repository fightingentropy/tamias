...
export const loadSettingsBillingData = createServerFn({ method: "GET" }).handler(async () => {
  const { buildSettingsBillingPageData } =
    await import("@/start/server/route-data/settings-billing");
