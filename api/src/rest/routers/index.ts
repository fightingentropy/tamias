...
import { selfAssessmentRouter } from "./self-assessment";
...
routers.route("/transaction-categories", transactionCategoriesRouter);
...
routers.route("/self-assessment", selfAssessmentRouter);
