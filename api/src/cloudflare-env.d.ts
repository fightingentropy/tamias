/* eslint-disable */
// Generated by Wrangler by running `wrangler types api/src/cloudflare-env.d.ts --config api/wrangler.jsonc` (hash: 8e782d535eeb394975dc1fec093d0033)
// Runtime types generated with workerd@1.20260329.1 2026-03-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./api-worker-entry");
	...
	interface StagingEnv {
		...
		TRUELAYER_REDIRECT_URI: "https://tamias-api-staging.erlinhoxha.workers.dev/apps/truelayer/oauth-callback";
		RATE_LIMIT_COORDINATOR: DurableObjectNamespace<import("./api-worker-entry").RateLimitCoordinator>;
		RUN_COORDINATOR: DurableObjectNamespace<import("./api-worker-entry").RunCoordinator>;
		ASYNC_WORKFLOW: Workflow<Parameters<import("./api-worker-entry").AsyncWorkflow['run']>[0]['payload']>;
	}
	...
	interface Env {
		...
		DASHBOARD_URL: "https://staging.tamias.xyz" | "https://app.tamias.xyz" | "http://127.0.0.1:8787";
		WEBSITE_URL: "https://staging.tamias.xyz" | "https://tamias.xyz" | "http://127.0.0.1:8787";
		API_URL: "https://api-staging.tamias.xyz" | "https://api.tamias.xyz" | "http://127.0.0.1:8787";
		CONVEX_URL: "https://fleet-chameleon-251.eu-west-1.convex.cloud";
		CONVEX_SITE_URL: "https://fleet-chameleon-251.eu-west-1.convex.site";
		TRUELAYER_CLIENT_ID?: "sandbox-tamias-7a82d0";
		TRUELAYER_ENVIRONMENT?: "sandbox";
		TRUELAYER_REDIRECT_URI?: "https://tamias-api-staging.erlinhoxha.workers.dev/apps/truelayer/oauth-callback" | "https://api.tamias.xyz/apps/truelayer/oauth-callback";
		RATE_LIMIT_COORDINATOR: DurableObjectNamespace<import("./api-worker-entry").RateLimitCoordinator>;
		RUN_COORDINATOR: DurableObjectNamespace<import("./api-worker-entry").RunCoordinator>;
		ASYNC_WORKFLOW: Workflow<Parameters<import("./api-worker-entry").AsyncWorkflow['run']>[0]['payload']>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TAMIAS_ENVIRONMENT" | "DASHBOARD_URL" | "WEBSITE_URL" | "API_URL" | "CONVEX_URL" | "CONVEX_SITE_URL" | "TRUELAYER_CLIENT_ID" | "TRUELAYER_ENVIRONMENT" | "TRUELAYER_REDIRECT_URI">> {}
}
