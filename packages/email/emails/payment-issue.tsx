...
export const PaymentIssueEmail = ({ fullName = "", teamName = "Tamias" }: Props) => {
      ...
      <Body className={`my-auto mx-auto font-sans ${themeClasses.body}`} style={lightStyles.body}>
        ...
        >
          ...
          <Text className={themeClasses.text} style={{ color: lightStyles.text.color }}>
            ...
            <br />
            <br />
            You won't lose access right away, but to keep things running you'll need to update your
            payment method.
          </Text>

          <Section className="text-center mt-[50px] mb-[50px]">
            <Button href={`${baseAppUrl}/settings/billing`}>Update payment method</Button>
          </Section>
