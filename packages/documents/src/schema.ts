...
export const invoiceSchema = z.object({
  ...
  total_amount: z
    .number()
    .nullable()
    .describe("Total amount for the invoice. Null if document_type is 'other'."),
  ...
  language: z
    ...
    .nullable()
    .describe(
      "The language of the document as a lowercase search language name (e.g., 'english', 'swedish', 'german', 'french')",
    ),
});
