/**
 * Core types for the @tamias/insights package
 */

// Import and re-export InsightPredictions from app-data (single source of truth)
import type { InsightPredictions } from "@tamias/app-data/types/insights";
...
// InsightPredictions is defined in @tamias/app-data/types/insights
