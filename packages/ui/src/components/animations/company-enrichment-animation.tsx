      ...
      >
        <div className="flex items-center gap-2 md:gap-3">
          <motion.div
            ...
            transition={{ duration: 0.25 }}
            className="w-7 h-7 md:w-9 md:h-9 rounded-full flex items-center justify-center flex-shrink-0 bg-primary/10 text-primary border border-border overflow-hidden"
          >
        ...
        >
          <p className="text-[10px] md:text-[11px] text-muted-foreground leading-relaxed">
            <span className="md:hidden">
              A technology company that provides enterprise cloud solutions and data synchronization
              services for businesses worldwide.
            </span>
            <span className="hidden md:inline">
              A technology company that provides enterprise cloud solutions and data synchronization
              services for businesses worldwide. The platform enables seamless data integration
              across multiple systems, offering real-time synchronization, advanced security
