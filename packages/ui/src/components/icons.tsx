...
export const Icons = {
  ...
  Logo: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={113} height={32} fill="none" {...props}>
      <path
        fill="currentColor"
  ...
  Instagram: (props: SVGIconProps) => (
    <SVGIcon {...props} viewBox="0 0 24 24">
      ...
      <rect x="4" y="4" width="16" height="16" rx="4" stroke="#fff" strokeWidth="2" fill="none" />
  ...
  Fortnox: ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 1550 1550" xmlns="http://www.w3.org/2000/svg">
      <path
        fill="#003824"
