...
interface UserSettingsNotificationType {
  type: string;
...
const USER_SETTINGS_NOTIFICATION_TYPES: UserSettingsNotificationType[] = [
  {
...
> {
  ...
  const notificationTypes = USER_SETTINGS_NOTIFICATION_TYPES;
