...
const dashboardHomeUrl = new URL("/dashboard", dashboardUrl).toString();
    ...
    const blocks = [
      ...
      // Status Section
      {
        ...
        accessory: {
          ...
          url: `${dashboardUrl}/apps?app=slack&settings=true`,
        ...
        elements: [
          {
            ...
            url: dashboardHomeUrl,
            action_id: "open_tamias",
          },
          {
            type: "button" as const,
            text: {
      ...
      // Footer
      {
        ...
        elements: [
          {
            type: "mrkdwn" as const,
            text: "Upload receipts by sharing files in channels where Tamias is added. Data will be automatically extracted and matched to your transactions.",
          },
        ],
      },
    ];
