...
export function formatWelcomeMessage(): string {
  const builder = new MessageBuilder();
  builder
    .header("Welcome to Tamias")
    .blank()
    .line("To connect your WhatsApp:")
    .bullet("Scan the QR code in your Tamias dashboard")
...
export function formatAlreadyConnectedMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("You're already connected to Tamias.")
    .blank()
...
export function formatAlreadyConnectedToAnotherTeamError(
  ...
  builder
    ...
    .line("from the current team first in your Tamias dashboard.")
    .blank()
    .footer();
...
export function formatProcessingErrorMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("Please try again or upload it directly in Tamias.")
    .blank();
...
export function formatNotConnectedMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("Your WhatsApp is not connected to Tamias yet.")
    .blank()
    .line("Please scan the QR code in your Tamias dashboard to connect.")
    .blank();
...
export function formatMatchDeclinedMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("You can review and match this receipt manually in Tamias.")
    .blank()
    .footer();
...
export function formatMatchActionErrorMessage(action: "confirm" | "decline"): string {
  ...
  builder
    ...
    .blank()
    .line("Please try again or handle this in Tamias.")
    .blank()
    .footer();
