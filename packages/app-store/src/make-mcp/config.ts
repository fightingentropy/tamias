...
export default {
  ...
  description: `Connect Make.com to your Tamias account using the Model Context Protocol (MCP).
...
- Connect Tamias with 1,500+ apps via Make

**How it works:**
1. Add the MCP Client module to your Make scenario
2. Configure the Tamias MCP server URL and authentication
3. Select tools and map inputs in the visual builder`,
  images: [],
  installUrl: "https://tamias.xyz/mcp/make",
};
