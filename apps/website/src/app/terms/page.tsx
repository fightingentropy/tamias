            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-sm sm:prose-base max-w-none space-y-6 font-sans text-foreground">
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  govern your relationship with the Tamias application (the
                  "Service") operated by Tamias Labs AB ("us", "we", or
                  "our").
                </p>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    cancel it or Tamias Labs AB cancels it. You may cancel
                    your Subscription through your online account management
                    page or by contacting Tamias Labs AB's customer support.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    If automatic billing fails, Tamias Labs AB will issue an
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB may modify Subscription fees at its sole
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    and are granted at the sole discretion of Tamias Labs AB.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB does not verify the accuracy or
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB is not a financial advisor, accountant, or
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB accepts no liability for any consequences,
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    providers. Tamias Labs AB does not verify the legal, tax,
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB relies on third-party services (e.g.,
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      Tamias Labs AB cannot guarantee the completeness,
                    ...
                    <li>
                      Tamias Labs AB shall not be liable for any loss,
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    <li>
                      Tamias Labs AB acts solely as a technical facilitator
                    ...
                    <li>
                      Tamias Labs AB is not responsible for errors,
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    constitutes infringement, please email dmca@tamias.xyz
                    with:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    remain the property of Tamias Labs AB and its licensors.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    services that are not controlled by Tamias Labs AB.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    We assume no responsibility for third-party content, privacy
                    policies, or practices. You agree that Tamias Labs AB
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB and its affiliates, directors, employees,
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    Tamias Labs AB regarding the Service.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-foreground leading-relaxed">
                    <a
                      href="mailto:support@tamias.xyz"
