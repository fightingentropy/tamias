            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-sm sm:prose-base max-w-none space-y-6 font-sans text-foreground">
                <p className="text-muted-foreground leading-relaxed">
                  Tamias Labs AB ("us", "we", or "our") operates the
                  Tamias application (hereinafter referred to as the
                  "Service").
                </p>
                ...
                <section className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Service is the Tamias application operated by
                        Tamias Labs AB
                      </p>
                    </div>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB uses the collected data for various
                    purposes:
                  </p>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias's use of information received from Google APIs
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    If you are from the European Economic Area (EEA), Tamias
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB may process your Personal Data because:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB will retain your Personal Data only for as
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB will also retain Usage Data for internal
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tamias Labs AB will take all the steps reasonably
                ...
                <section className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        If Tamias Labs AB is involved in a merger,
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Under certain circumstances, Tamias Labs AB may be
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Tamias Labs AB may disclose your Personal Data in the
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    you have certain data protection rights. Tamias Labs AB
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      ...
                      Tamias Labs AB relied on your consent to process your
                      personal information.
                    </li>
                  </ul>
                  <p className="text-muted-foreground leading-relaxed mt-2">
