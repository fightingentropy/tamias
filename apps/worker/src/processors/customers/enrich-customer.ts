...
/**
 * Enriches customer data using a bounded multi-step research loop.
 *
 * Pipeline:
 * 1. Run a single targeted web search pass
 * 2. Extract structured customer data
 * 3. Verify the extracted fields before persisting them
 *
 * Features:
 * - Tool-backed research with a hard step limit
 * - Automatic timeout (60s for full pipeline)
 * - Retry support via the async queue runtime
