/* eslint-disable */
// Generated by Wrangler by running `wrangler types /Users/erlinhoxha/Developer/tamias/apps/worker/src/cloudflare-env.d.ts --config /Users/erlinhoxha/Developer/tamias/apps/worker/wrangler.jsonc --cwd /var/folders/5n/sh5dc26j4szd1klgq0rgw54r0000gn/T/tmp.J4P6ULKtNl --env-file /Users/erlinhoxha/Developer/tamias/apps/worker/.env-template` (hash: 698a06dd67515eaa7a6ead143b51a631)
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		EXA_API_KEY: string;
		INSIGHTS_ENABLED_TEAM_IDS: string;
		INSIGHTS_NOTIFICATIONS_ENABLED: string;
		ELEVENLABS_API_KEY: string;
		ELEVENLABS_VOICE_ID: string;
		INSIGHTS_AUDIO_TOKEN_SECRET: string;
		API_URL: string;
		RUN_COORDINATOR: DurableObjectNamespace<import("./cloudflare/index").RunCoordinator>;
		ASYNC_WORKFLOW: Workflow<Parameters<import("./cloudflare/index").AsyncWorkflow['run']>[0]['payload']>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TAMIAS_ENVIRONMENT" | "CONVEX_URL" | "CONVEX_SITE_URL" | "CLOUDFLARE_ASYNC_BRIDGE_TOKEN" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "SLACK_SIGNING_SECRET" | "SLACK_STATE_SECRET" | "SLACK_OAUTH_REDIRECT_URL" | "OPENAI_API_KEY" | "GOOGLE_GENERATIVE_AI_API_KEY" | "RESEND_API_KEY" | "RESEND_AUDIENCE_ID" | "PLAID_CLIENT_ID" | "PLAID_SECRET" | "PLAID_ENVIRONMENT" | "GOCARDLESS_SECRET_ID" | "GOCARDLESS_SECRET_KEY" | "ENABLEBANKING_APPLICATION_ID" | "ENABLE_BANKING_KEY_CONTENT" | "ENABLEBANKING_REDIRECT_URL" | "R2_ENDPOINT" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_BUCKET_NAME" | "LOGO_DEV_TOKEN" | "NODE_ENV" | "WORKER_ENV" | "INTERNAL_API_KEY" | "WHATSAPP_PHONE_NUMBER_ID" | "WHATSAPP_BUSINESS_ACCOUNT_ID" | "WHATSAPP_ACCESS_TOKEN" | "WHATSAPP_VERIFY_TOKEN" | "WHATSAPP_APP_SECRET" | "MISTRAL_API_KEY" | "XERO_CLIENT_ID" | "XERO_CLIENT_SECRET" | "XERO_OAUTH_REDIRECT_URL" | "QUICKBOOKS_CLIENT_ID" | "QUICKBOOKS_CLIENT_SECRET" | "QUICKBOOKS_OAUTH_REDIRECT_URL" | "QUICKBOOKS_ENVIRONMENT" | "FORTNOX_CLIENT_ID" | "FORTNOX_CLIENT_SECRET" | "FORTNOX_OAUTH_REDIRECT_URL" | "INVOICE_JWT_SECRET" | "EXA_API_KEY" | "INSIGHTS_ENABLED_TEAM_IDS" | "INSIGHTS_NOTIFICATIONS_ENABLED" | "ELEVENLABS_API_KEY" | "ELEVENLABS_VOICE_ID" | "INSIGHTS_AUDIO_TOKEN_SECRET" | "API_URL">> {}
}
