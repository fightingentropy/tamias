        ...
        if (isApprove) {
          ...
          try {
            ...
            await confirmSuggestedMatch(db, {
              ...
              inboxId,
              transactionId,
              userId: undefined, // Slack interactions don't have Tamias user ID mapping
              teamId,
            });
                    ...
                    elements: [
                      {
                        ...
                        url: `${dashboardUrl}/transactions?id=${encodeURIComponent(transactionId)}`,
                ...
                blocks: [
                  {
                    ...
                    text: {
                      type: "mrkdwn",
                      text: "❌ *Match declined*\n\nThe suggestion has been dismissed. You can manually match this receipt in Tamias.",
                    },
                  },
                  {
                    type: "actions",
                    elements: [
                      {
                        ...
                        url: `${dashboardUrl}/inbox?inboxId=${encodeURIComponent(inboxId)}`,
