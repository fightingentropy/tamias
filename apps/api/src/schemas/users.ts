...
export const updateUserSchema = z.object({
  ...
  avatarUrl: z
    .string()
    .url()
    .refine((url) => url.includes("tamias.xyz"), {
      message: "avatarUrl must be a tamias.xyz domain URL",
    })
    .optional()
    .openapi({
      description:
  ...
  aiProvider: z.enum(AI_PROVIDER_VALUES).optional().openapi({
    description: "Assistant provider used for chat requests",
    example: "openai",
  }),
});
...
export const userSchema = z.object({
  ...
  aiProvider: z.enum(AI_PROVIDER_VALUES).openapi({
    description: "Assistant provider used for chat requests",
    example: "openai",
  }),
