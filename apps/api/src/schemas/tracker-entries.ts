      ...
      example: [
        {
          ...
          dates: ["2024-04-15"],
          assignedId: "k57c9j9m4xw2n8h7p6q5r4s3t2u1v0w",
  ...
  user: z
    .object({
      ...
      avatarUrl: z.string().openapi({
        ...
        example: "https://cdn.tamias.xyz/avatar.jpg",
      }),
    })
    .openapi({
      description:
...
export const stopTimerSchema = z.object({
  ...
  assignedId: z.string().optional().nullable().openapi({
    description:
      "Canonical app user ID whose timer should be stopped. If not provided, will use the authenticated user",
    example: "k57c9j9m4xw2n8h7p6q5r4s3t2u1v0w",
  }),
...
export const getCurrentTimerSchema = z.object({
  assignedId: z.string().optional().nullable().openapi({
    description:
      "Canonical app user ID whose current timer should be retrieved. If not provided, will use the authenticated user",
    example: "k57c9j9m4xw2n8h7p6q5r4s3t2u1v0w",
  }),
});
