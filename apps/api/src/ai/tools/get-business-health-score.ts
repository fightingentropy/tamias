import { businessHealthScoreArtifact } from "@tamias/ai-artifacts/business-health-score";
import { db } from "@tamias/app-data/client";
import { getCashFlow, getExpenses, getReports } from "@tamias/app-data/queries";
import { tool } from "ai";
  ...
  execute: async function* (
    ...
    try {
      ...
      const analysis = startArtifactStream({
        enabled: showCanvas,
        executionOptions,
        artifact: businessHealthScoreArtifact,
        input: {
          stage: "loading",
