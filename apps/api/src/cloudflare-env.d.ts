/* eslint-disable */
// Generated by Wrangler by running `wrangler types /Users/erlinhoxha/Developer/tamias/apps/api/src/cloudflare-env.d.ts --config /Users/erlinhoxha/Developer/tamias/apps/api/wrangler.jsonc --cwd /var/folders/5n/sh5dc26j4szd1klgq0rgw54r0000gn/T/tmp.zJYqg6lV5e --env-file /Users/erlinhoxha/Developer/tamias/apps/api/.env-template` (hash: e8ecb5d4c9cb2f1679aaab4251a6142e)
// Runtime types generated with workerd@1.20260329.1 2026-03-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "RateLimitCoordinator";
	}
	interface StagingEnv {
		...
		CLOUDFLARE_ASYNC_BRIDGE_URL: string;
		...
		RATE_LIMIT_COORDINATOR: DurableObjectNamespace<import("./index").RateLimitCoordinator>;
		ASYNC_WORKER: Service /* entrypoint AsyncBridgeService from tamias-async-staging */;
	}
	interface ProductionEnv {
		...
		COMPANIES_HOUSE_XML_PACKAGE_REFERENCE: string;
		RATE_LIMIT_COORDINATOR: DurableObjectNamespace<import("./index").RateLimitCoordinator>;
		ASYNC_WORKER: Service /* entrypoint AsyncBridgeService from tamias-async */;
	}
	interface Env {
		TAMIAS_ENVIRONMENT: "staging" | "production" | "development";
		DASHBOARD_URL: "https://staging.tamias.xyz" | "https://app.tamias.xyz" | "http://localhost:3001";
		...
		COMPANIES_HOUSE_XML_PACKAGE_REFERENCE: string;
		RATE_LIMIT_COORDINATOR: DurableObjectNamespace<import("./index").RateLimitCoordinator>;
		ASYNC_WORKER: Service /* entrypoint AsyncBridgeService from tamias-async-staging */ | Service /* entrypoint AsyncBridgeService from tamias-async */ | Service /* entrypoint AsyncBridgeService from tamias-async-local */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TAMIAS_ENVIRONMENT" | "DASHBOARD_URL" | "WEBSITE_URL" | "API_URL" | "RESEND_API_KEY" | "CONVEX_URL" | "CONVEX_SITE_URL" | "CONVEX_SERVICE_KEY" | "PLAID_CLIENT_ID" | "PLAID_SECRET" | "PLAID_ENVIRONMENT" | "GOCARDLESS_SECRET_ID" | "GOCARDLESS_SECRET_KEY" | "ENABLEBANKING_APPLICATION_ID" | "ENABLE_BANKING_KEY_CONTENT" | "ENABLEBANKING_REDIRECT_URL" | "TELLER_SIGNING_SECRET" | "R2_ENDPOINT" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_BUCKET_NAME" | "LOGO_DEV_TOKEN" | "OPENAI_API_KEY" | "ALLOWED_API_ORIGINS" | "LOG_LEVEL" | "INVOICE_JWT_SECRET" | "TAMIAS_ENCRYPTION_KEY" | "CLOUDFLARE_ASYNC_BRIDGE_URL" | "CLOUDFLARE_ASYNC_BRIDGE_TOKEN" | "POLAR_ACCESS_TOKEN" | "POLAR_ENVIRONMENT" | "POLAR_WEBHOOK_SECRET" | "NODE_ENV" | "GOOGLE_GENERATIVE_AI_API_KEY" | "LOG_PRETTY" | "INBOX_WEBHOOK_USERNAME" | "INBOX_WEBHOOK_PASSWORD" | "FILE_KEY_SECRET" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "SLACK_OAUTH_REDIRECT_URL" | "SLACK_STATE_SECRET" | "SLACK_SIGNING_SECRET" | "OUTLOOK_CLIENT_ID" | "OUTLOOK_CLIENT_SECRET" | "OUTLOOK_REDIRECT_URI" | "WHATSAPP_PHONE_NUMBER_ID" | "WHATSAPP_BUSINESS_ACCOUNT_ID" | "WHATSAPP_ACCESS_TOKEN" | "WHATSAPP_VERIFY_TOKEN" | "WHATSAPP_APP_SECRET" | "MISTRAL_API_KEY" | "XERO_CLIENT_ID" | "XERO_CLIENT_SECRET" | "XERO_OAUTH_REDIRECT_URL" | "QUICKBOOKS_CLIENT_ID" | "QUICKBOOKS_CLIENT_SECRET" | "QUICKBOOKS_OAUTH_REDIRECT_URL" | "QUICKBOOKS_ENVIRONMENT" | "FORTNOX_CLIENT_ID" | "FORTNOX_CLIENT_SECRET" | "FORTNOX_OAUTH_REDIRECT_URL" | "STRIPE_SECRET_KEY" | "STRIPE_PUBLISHABLE_KEY" | "STRIPE_CONNECT_CLIENT_ID" | "STRIPE_CONNECT_WEBHOOK_SECRET" | "ELEVENLABS_API_KEY" | "ELEVENLABS_VOICE_ID" | "INSIGHTS_AUDIO_TOKEN_SECRET" | "GITHUB_RELEASE_TOKEN" | "INTERNAL_API_KEY" | "COMPANIES_HOUSE_CLIENT_ID" | "COMPANIES_HOUSE_CLIENT_SECRET" | "COMPANIES_HOUSE_OAUTH_REDIRECT_URL" | "COMPANIES_HOUSE_ENVIRONMENT" | "COMPANIES_HOUSE_API_KEY" | "COMPANIES_HOUSE_XML_ENVIRONMENT" | "COMPANIES_HOUSE_XML_PRESENTER_ID" | "COMPANIES_HOUSE_XML_PRESENTER_AUTHENTICATION_CODE" | "COMPANIES_HOUSE_XML_PACKAGE_REFERENCE">> {}
}
