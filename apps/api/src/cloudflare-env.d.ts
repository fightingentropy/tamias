...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GITHUB_RELEASE_TOKEN: string;
		INTERNAL_API_KEY: string;
		ASYNC_WORKER: Service /* entrypoint AsyncBridgeService from tamias-async-staging */ | Service /* entrypoint AsyncBridgeService from tamias-async */ | Service /* entrypoint AsyncBridgeService from tamias-async-preview */;
	}
}
