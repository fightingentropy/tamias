...
declare namespace Cloudflare {
  ...
  interface StagingEnv {
    ...
    RATE_LIMIT_COORDINATOR: DurableObjectNamespace<
      import("./index").RateLimitCoordinator
    >;
  ...
  interface Env {
    ...
    >;
    ASYNC_WORKER:
      | Service /* entrypoint AsyncBridgeService from tamias-async-staging */
      | Service /* entrypoint AsyncBridgeService from tamias-async */
      | Service /* entrypoint AsyncBridgeService from tamias-async-local */;
  }
}
