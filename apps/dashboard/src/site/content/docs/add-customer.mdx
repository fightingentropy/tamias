...
Customers in Tamias store the information you need for invoicing and tracking work.

## Add a customer

1. Go to [Customers](https://tamias.xyz/customers)
...
Tamias can automatically enrich customer profiles:
