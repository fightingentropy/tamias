...
Recurring invoices save time for ongoing client relationships. Set it once, and Tamias sends invoices automatically.
...
1. Go to [Invoices](https://tamias.xyz/invoices) → **Create invoice**
