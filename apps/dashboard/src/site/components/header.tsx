      ...
      <nav className="fixed top-0 left-0 right-0 z-50 w-full">
        ...
        >
          ...
          <Link
            ...
            aria-label="Tamias - Go to homepage"
          >
            <div className="w-6 h-6">
              <SiteLogoSmallIcon className="w-full h-full text-foreground" />
            </div>
                        ...
                        >
                          <div className="grid grid-cols-2 gap-x-4">
                            ...
                            <div>
                              {[
                                {
                                  href: "https://api.tamias.xyz",
                                  title: "Developer & API",
                                  desc: "Programmatic access to Tamias.",
                                  external: true,
                                },
                              ].map((item, index) => (
                                <div
