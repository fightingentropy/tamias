...
import { CopilotMcpLogo } from "@tamias/app-store/logos";
...
export function MCPCopilot() {
  ...
  const connectionConfig = useMemo(() => {
    ...
    return `Server URL: https://api.tamias.xyz/mcp
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4 mb-8">
              ...
              <p className="font-sans text-base text-muted-foreground leading-relaxed">
                Connect Tamias to Microsoft Copilot Studio. Ask about
                invoices, transactions, and reports from Word, Excel, Outlook,
                or any Copilot-enabled app.
              </p>
            </div>
            ...
            <div className="space-y-4 mb-8">
              ...
              <p className="font-sans text-sm text-muted-foreground">
                Use these settings when adding Tamias as an MCP server in
                Copilot Studio:
              </p>
            ...
            <div className="mt-12 space-y-4">
              ...
              <ol className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div className="pt-0.5">
                    <span className="font-sans text-sm text-foreground font-medium">
                      Start using Tamias tools
                    </span>
                    <p className="font-sans text-sm text-muted-foreground mt-1">
                      Tamias's tools will appear in your agent. Ask questions
            ...
            <div className="mt-12 p-6 bg-secondary/50 border border-border">
              ...
              <ul className="space-y-2">
                ...
                <li className="font-sans text-sm text-muted-foreground flex items-start gap-2">
                  <span className="text-foreground">•</span>
                  Tamias API key (create in Settings → Developer)
                </li>
              </ul>
              <div className="mt-4">
