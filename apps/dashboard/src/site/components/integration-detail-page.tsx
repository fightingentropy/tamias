...
import { apps, getCategoryName } from "@/site/data/apps";
...
export function IntegrationDetailPage({ app }: Props) {
  ...
  const dashboardUrl = app.active
    ? `https://tamias.xyz/apps?app=${app.id}`
    : undefined;
            ...
            <div className="sticky top-32 space-y-6">
              ...
              <div className="border border-border p-6">
                ...
                <p className="font-sans text-sm text-muted-foreground mb-6">
                  {app.active
                    ? `Connect ${app.name} to your Tamias account and start automating your workflow.`
