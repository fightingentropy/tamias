...
import { AIAssistantAnimation } from "@tamias/ui/animations/ai-assistant";
import { BurnrateAnimation } from "@tamias/ui/animations/burnrate";
...
export function Insights() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <AudioSummarySection audioUrl="https://cdn.tamias.xyz/weekly-speech.mp3" />
