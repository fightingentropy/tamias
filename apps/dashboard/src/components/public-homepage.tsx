...
const AIAssistantAnimation = dynamic(() =>
  import("@tamias/ui/animations/ai-assistant").then(
...
const InvoicePaymentAnimation = dynamic(() =>
  import("@tamias/ui/animations/invoice-payment").then(
    (m) => m.InvoicePaymentAnimation,
  ),
);
const TransactionFlowAnimation = dynamic(() =>
  import("@tamias/ui/animations/transaction-flow").then(
...
const FeaturesGridSection = dynamic(() =>
  import("./public-homepage/sections/features-grid-section").then(
    (m) => m.FeaturesGridSection,
  ),
);
const TimeSavingsSection = dynamic(() =>
  import("./public-homepage/sections/time-savings-section").then(
    (m) => m.TimeSavingsSection,
  ),
);
const WeeklyAudioSection = dynamic(() =>
  import("./public-homepage/sections/weekly-audio-section").then(
    (m) => m.WeeklyAudioSection,
  ),
);
const PreAccountingSection = dynamic(() =>
  import("./public-homepage/sections/pre-accounting-section").then(
    (m) => m.PreAccountingSection,
  ),
);
const IntegrationsSection = dynamic(() =>
  import("./public-homepage/sections/integrations-section").then(
    (m) => m.IntegrationsSection,
  ),
);
const PricingSection = dynamic(() =>
  import("./public-homepage/sections/pricing-section").then(
    (m) => m.PricingSection,
  ),
);
...
const features = [
  ...
  },
  {
    ...
    subtitle:
      "Tamias explains changes in cash, revenue, and spending as they happen.",
...
const footerColumns = [
  {
    title: "Features",
    links: [
      { href: "https://tamias.xyz/assistant", label: "Assistant" },
      { href: "https://tamias.xyz/insights", label: "Insights" },
      { href: "https://tamias.xyz/transactions", label: "Transactions" },
      { href: "https://tamias.xyz/inbox", label: "Inbox" },
    ],
  },
  {
    title: "Product",
    links: [
      ...
      { href: "https://tamias.xyz/pre-accounting", label: "Pre-accounting" },
      { href: "https://tamias.xyz/integrations", label: "Integrations" },
      { href: "https://tamias.xyz/updates", label: "Updates" },
    ],
  },
  {
    title: "Company",
    links: [
      { href: "https://tamias.xyz/story", label: "Story" },
      { href: "https://tamias.xyz/support", label: "Support" },
      { href: "https://x.com/tamias", label: "X / Twitter" },
      {
        href: "https://www.linkedin.com/company/tamias",
        label: "LinkedIn",
      },
    ],
  },
  {
    title: "Resources",
    links: [
      { href: "https://tamias.xyz/docs", label: "Documentation" },
      { href: "https://api.tamias.xyz", label: "API" },
      { href: "https://tamias.xyz/policy", label: "Privacy Policy" },
      { href: "https://tamias.xyz/terms", label: "Terms of Service" },
    ],
  },
] as const;
...
export function PublicHomepage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <nav className="fixed inset-x-0 top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-[1400px] items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button asChild className="btn-inverse">
            ...
            <div className="flex flex-col items-center w-full text-center space-y-6 lg:space-y-8">
              <div className="space-y-5 lg:space-y-6 max-w-3xl 3xl:max-w-5xl mx-auto px-2 lg:px-0">
                ...
                <p className="text-muted-foreground text-base lg:text-lg leading-relaxed font-sans max-w-xl mx-auto">
                  Tamias takes care of admin, matches receipts automatically,
      ...
      <WeeklyAudioSection audioUrl="https://cdn.tamias.xyz/weekly-speech.mp3" />
      ...
      <footer className="border-t border-border bg-background px-4 py-16">
        <div className="mx-auto grid w-full max-w-[1400px] gap-12 lg:grid-cols-[1.2fr_2fr]">
          <div className="space-y-4">
            <p className="font-serif text-3xl text-foreground sm:text-4xl">
              Run your company. Not the admin.
            </p>
            <p className="max-w-md text-sm leading-6 text-muted-foreground">
              One place for transactions, receipts, invoices, reporting, and the
              weekly clarity you usually have to piece together yourself.
            </p>
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {footerColumns.map((column) => (
              <div key={column.title} className="space-y-4">
                <h2 className="text-sm text-foreground">{column.title}</h2>
