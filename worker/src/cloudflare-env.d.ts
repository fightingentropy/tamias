/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/src/cloudflare-env.d.ts --config wrangler.jsonc` (hash: 4b61b18a046c0c7861d1c1eb1d75adbd)
// Runtime types generated with workerd@1.20260329.1 2026-03-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../dashboard/dist/server/index");
		durableNamespaces: "RateLimitCoordinator" | "RunCoordinator";
	}
	interface StagingEnv {
		...
		COMPANIES_HOUSE_CLIENT_ID: string;
		COMPANIES_HOUSE_CLIENT_SECRET: string;
		COMPANIES_HOUSE_ENVIRONMENT: string;
		COMPANIES_HOUSE_OAUTH_REDIRECT_URL: string;
		COMPANIES_HOUSE_XML_ENVIRONMENT: string;
		COMPANIES_HOUSE_XML_PACKAGE_REFERENCE: string;
		COMPANIES_HOUSE_XML_PRESENTER_AUTHENTICATION_CODE: string;
		COMPANIES_HOUSE_XML_PRESENTER_ID: string;
		...
		EXA_API_KEY: string;
		FILE_KEY_SECRET: string;
		FORTNOX_CLIENT_ID: string;
		FORTNOX_CLIENT_SECRET: string;
		FORTNOX_OAUTH_REDIRECT_URL: string;
		GITHUB_RELEASE_TOKEN: string;
		GOOGLE_GENERATIVE_AI_API_KEY: string;
		HMRC_CT_ENVIRONMENT: string;
		HMRC_CT_PRODUCT_NAME: string;
		HMRC_CT_PRODUCT_VERSION: string;
		HMRC_CT_SENDER_ID: string;
		HMRC_CT_SENDER_PASSWORD: string;
		HMRC_CT_TEST_UTR: string;
		HMRC_CT_VENDOR_ID: string;
		HMRC_VAT_CLIENT_ID: string;
		HMRC_VAT_CLIENT_SECRET: string;
		HMRC_VAT_ENVIRONMENT: string;
		HMRC_VAT_OAUTH_REDIRECT_URL: string;
		INBOX_WEBHOOK_PASSWORD: string;
		INBOX_WEBHOOK_USERNAME: string;
		INSIGHTS_AUDIO_TOKEN_SECRET: string;
		INTERNAL_API_KEY: string;
		INVOICE_JWT_SECRET: string;
		...
		QUICKBOOKS_OAUTH_REDIRECT_URL: string;
		...
		XERO_OAUTH_REDIRECT_URL: string;
		DASHBOARD_URL: string;
		API_SERVICE: Fetcher /* tamias-api-staging */;
	}
	interface ProductionEnv {
		...
		XERO_OAUTH_REDIRECT_URL: string;
		DASHBOARD_URL: string;
		API_SERVICE: Fetcher /* tamias-api */;
	}
	interface Env {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		TAMIAS_ENVIRONMENT: "staging" | "production" | "development";
		WEBSITE_URL: "https://staging.tamias.xyz" | "https://tamias.xyz" | "http://127.0.0.1:8787";
		ALLOWED_API_ORIGINS: string;
		API_URL: string;
		COMPANIES_HOUSE_API_KEY: string;
		COMPANIES_HOUSE_CLIENT_ID: string;
		...
		XERO_OAUTH_REDIRECT_URL: string;
		DASHBOARD_URL: string;
		API_SERVICE?: Fetcher /* tamias-api-staging */ | Fetcher /* tamias-api */;
		EMAIL?: SendEmail;
		CAPTURE_QUEUE?: Queue;
		LEDGER_QUEUE?: Queue;
		RATE_LIMIT_COORDINATOR?: DurableObjectNamespace /* RateLimitCoordinator */;
		RUN_COORDINATOR?: DurableObjectNamespace /* RunCoordinator */;
		ASYNC_WORKFLOW?: Workflow /* AsyncWorkflow */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TAMIAS_ENVIRONMENT" | "WEBSITE_URL" | "ALLOWED_API_ORIGINS" | "API_URL" | "COMPANIES_HOUSE_API_KEY" | "COMPANIES_HOUSE_CLIENT_ID" | "COMPANIES_HOUSE_CLIENT_SECRET" | "COMPANIES_HOUSE_ENVIRONMENT" | "COMPANIES_HOUSE_OAUTH_REDIRECT_URL" | "COMPANIES_HOUSE_XML_ENVIRONMENT" | "COMPANIES_HOUSE_XML_PACKAGE_REFERENCE" | "COMPANIES_HOUSE_XML_PRESENTER_AUTHENTICATION_CODE" | "COMPANIES_HOUSE_XML_PRESENTER_ID" | "CONVEX_SERVICE_KEY" | "CONVEX_SITE_URL" | "CONVEX_URL" | "ELEVENLABS_API_KEY" | "ELEVENLABS_VOICE_ID" | "EXA_API_KEY" | "FILE_KEY_SECRET" | "FORTNOX_CLIENT_ID" | "FORTNOX_CLIENT_SECRET" | "FORTNOX_OAUTH_REDIRECT_URL" | "GITHUB_RELEASE_TOKEN" | "GOOGLE_GENERATIVE_AI_API_KEY" | "HMRC_CT_ENVIRONMENT" | "HMRC_CT_PRODUCT_NAME" | "HMRC_CT_PRODUCT_VERSION" | "HMRC_CT_SENDER_ID" | "HMRC_CT_SENDER_PASSWORD" | "HMRC_CT_TEST_UTR" | "HMRC_CT_VENDOR_ID" | "HMRC_VAT_CLIENT_ID" | "HMRC_VAT_CLIENT_SECRET" | "HMRC_VAT_ENVIRONMENT" | "HMRC_VAT_OAUTH_REDIRECT_URL" | "INBOX_WEBHOOK_PASSWORD" | "INBOX_WEBHOOK_USERNAME" | "INSIGHTS_AUDIO_TOKEN_SECRET" | "INTERNAL_API_KEY" | "INVOICE_JWT_SECRET" | "LOGO_DEV_TOKEN" | "LOG_LEVEL" | "LOG_PRETTY" | "MISTRAL_API_KEY" | "NEXT_PUBLIC_CONVEX_SITE_URL" | "NEXT_PUBLIC_CONVEX_URL" | "NODE_ENV" | "OPENAI_API_KEY" | "OPENROUTER_API_KEY" | "OUTLOOK_CLIENT_ID" | "OUTLOOK_CLIENT_SECRET" | "OUTLOOK_REDIRECT_URI" | "POLAR_ACCESS_TOKEN" | "POLAR_ENVIRONMENT" | "POLAR_WEBHOOK_SECRET" | "QUICKBOOKS_CLIENT_ID" | "QUICKBOOKS_CLIENT_SECRET" | "QUICKBOOKS_ENVIRONMENT" | "QUICKBOOKS_OAUTH_REDIRECT_URL" | "R2_ACCESS_KEY_ID" | "R2_BUCKET_NAME" | "R2_ENDPOINT" | "R2_SECRET_ACCESS_KEY" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "SLACK_OAUTH_REDIRECT_URL" | "SLACK_SIGNING_SECRET" | "SLACK_STATE_SECRET" | "STRIPE_CONNECT_CLIENT_ID" | "STRIPE_CONNECT_WEBHOOK_SECRET" | "STRIPE_PUBLISHABLE_KEY" | "STRIPE_SECRET_KEY" | "SUPABASE_JWT_SECRET" | "SUPABASE_SERVICE_KEY" | "SUPABASE_URL" | "TAMIAS_ENCRYPTION_KEY" | "TRUELAYER_CLIENT_ID" | "TRUELAYER_CLIENT_SECRET" | "TRUELAYER_ENVIRONMENT" | "TRUELAYER_REDIRECT_URI" | "UK_COMPLIANCE_ENABLED" | "WHATSAPP_ACCESS_TOKEN" | "WHATSAPP_APP_SECRET" | "WHATSAPP_BUSINESS_ACCOUNT_ID" | "WHATSAPP_PHONE_NUMBER_ID" | "WHATSAPP_VERIFY_TOKEN" | "XERO_CLIENT_ID" | "XERO_CLIENT_SECRET" | "XERO_OAUTH_REDIRECT_URL" | "DASHBOARD_URL">> {}
}
