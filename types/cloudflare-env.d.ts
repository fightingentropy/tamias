/* eslint-disable */
// Generated by Wrangler by running `wrangler types types/cloudflare-env.d.ts --config wrangler.jsonc` (hash: a59475b707d7e51354b4e666962f0e39)
// Runtime types generated with workerd@1.20260508.1 2026-03-28 nodejs_compat
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		RATE_LIMIT_COORDINATOR: DurableObjectNamespace<import("../dashboard/dist/server/index").RateLimitCoordinator>;
		RUN_COORDINATOR: DurableObjectNamespace<import("../dashboard/dist/server/index").RunCoordinator>;
		DOCUMENTS_WORKER: Fetcher /* tamias-documents */;
		ASYNC_WORKFLOW: Workflow<Parameters<import("../dashboard/dist/server/index").AsyncWorkflow['run']>[0]['payload']>;
	}
	interface Env {
		VAULT_BUCKET: R2Bucket;
		APP_DB: D1Database;
		...
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		TAMIAS_ENVIRONMENT: "production" | "development";
		WEBSITE_URL: "https://tamias.xyz" | "http://127.0.0.1:8787";
		ALLOWED_API_ORIGINS: string;
		API_URL: string;
		COMPANIES_HOUSE_API_KEY: string;
		COMPANIES_HOUSE_CLIENT_ID: string;
		...
		RATE_LIMIT_COORDINATOR: DurableObjectNamespace<import("../dashboard/dist/server/index").RateLimitCoordinator>;
		RUN_COORDINATOR: DurableObjectNamespace<import("../dashboard/dist/server/index").RunCoordinator>;
		DOCUMENTS_WORKER: Fetcher /* tamias-documents */ | Fetcher /* tamias-documents-local */;
		ASYNC_WORKFLOW: Workflow<Parameters<import("../dashboard/dist/server/index").AsyncWorkflow['run']>[0]['payload']>;
	}
}
