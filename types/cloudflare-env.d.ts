/* eslint-disable */
// Generated by Wrangler by running `wrangler types types/cloudflare-env.d.ts --config wrangler.jsonc --env-file /dev/null` (hash: 22fe9ff712d899ef9d33259e57923648)
...
declare namespace Cloudflare {
  ...
  interface ProductionEnv {
    ...
    HMRC_FRAUD_TRUST_CLIENT_PORT: "true";
    HMRC_FRAUD_TRUST_VENDOR_IP: "false";
    ...
    RATE_LIMIT_COORDINATOR: DurableObjectNamespace<
      import("../dashboard/dist/server/index").RateLimitCoordinator
    >;
    RUN_COORDINATOR: DurableObjectNamespace<
      import("../dashboard/dist/server/index").RunCoordinator
    >;
    DOCUMENTS_WORKER: Fetcher /* tamias-documents */;
    ASYNC_WORKFLOW: Workflow<
      Parameters<import("../dashboard/dist/server/index").AsyncWorkflow["run"]>[0]["payload"]
    >;
  }
  interface Env {
    VAULT_BUCKET: R2Bucket;
    ...
    DASHBOARD_URL: "https://app.tamias.xyz" | "http://127.0.0.1:8787";
    WEBSITE_URL: "https://tamias.xyz" | "http://127.0.0.1:8787";
    API_URL: "https://api.tamias.xyz" | "http://127.0.0.1:8787";
    HMRC_FRAUD_TRUST_CLIENT_PORT?: "true";
    HMRC_FRAUD_TRUST_VENDOR_IP?: "false";
    TRUELAYER_CLIENT_ID?: "sandbox-tamias-7a82d0";
    TRUELAYER_ENVIRONMENT?: "sandbox";
