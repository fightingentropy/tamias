/* eslint-disable */
// Generated by Wrangler by running `wrangler types types/cloudflare-env.d.ts --config wrangler.jsonc --env-file /dev/null` (hash: 046aea2cb3a193d4386d841fedcc5fdb)
